  ...
  return (
    <div className="min-h-screen bg-sage">
        ...
        <main className="relative z-0 px-5 sm:px-8">
          ...
          {/* Footer */}
          <footer className="border-t border-[#143225]/10 py-6 px-5 sm:px-8">
            <div className="max-w-[1040px] mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">

              {/* Social icons — LinkedIn and Instagram only (matches foodserviceiq.com footer) */}
              <div className="flex items-center gap-5">
                {/* LinkedIn */}
                <a
                  href="https://www.linkedin.com/company/106540602"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="FoodServiceIQ on LinkedIn"
                  className="p-3 -m-3 text-[#94a3b8] hover:text-[#143225] transition-colors"
                >
                ...
                {/* Instagram */}
                <a
                  href="https://www.instagram.com/foodserviceiq/"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="FoodServiceIQ on Instagram"
                  className="p-3 -m-3 text-[#94a3b8] hover:text-[#143225] transition-colors"
                >
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              ...
              {/* Privacy */}
              <a
                href="https://www.foodserviceiq.com/privacy-policy"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[11px] text-[#94a3b8] hover:text-[#143225] underline transition-colors"
              >
                Privacy Policy
              </a>
